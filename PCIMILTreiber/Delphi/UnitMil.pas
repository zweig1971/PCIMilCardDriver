...
function PCI_MilBusCMDWrite(CardNr:_BYTE; cmd:_WORD; var ErrorStatus:_DWORD):_DWORD;
                            cdecl; external 'PCIMilTreiber.dll';
...
// gibt den klartext der fehlernummer als string zurueck
procedure ErrorString(ErrorStatus:_DWORD; var ErrSring:string);
...
begin
     ...
     for i := 1 to Length(Error_Char) do begin
         ErrSring := ErrSring + Error_Char[i];
     end;
end;
