...
bool pulse_tester(_WORD Cardauswahl, string &ErrorMessage, bool ScreenOut, int loop)
{
	...
	if(ScreenOut)
	{
		...
		cout <<"Set Event 1 EventOff & Puls1_On      :"<<endl;
		cout <<"Set Event 2 EventOff & Puls1_On      :"<<endl;
		cout <<"Switch Event Filter on               :"<<endl;
		cout <<"Set Rahmen Puls 1 Off                :"<<endl;
		cout <<"Set Rahmen Puls 2 Off                :"<<endl;
	...
	if(EventValue != EvFilter_Start_Puls1)
	{
		if(ScreenOut)
		{
			SetConsoleTextAttribute(hConsoleOut, BACKGROUND_RED | FOREGROUND_WHITE);  
	...
	PCI_EvFilterSet(Cardauswahl, 2, Puls2_On, ErrorStatus);
	...
	if(EventValue != EvFilter_Start_Puls2)
	{
		if(ScreenOut)
		{
			SetConsoleTextAttribute(hConsoleOut, BACKGROUND_RED | FOREGROUND_WHITE);  
	...
	PCI_CntrlRegSet(Cardauswahl, Cntrl_Puls1_Rahmen_Off, ErrorStatus);
	...
	if((CntrlRegValue & Ctrl_Puls1_Rahmen_On) != 0)
	{
		if(ScreenOut)
		{
			SetConsoleTextAttribute(hConsoleOut, BACKGROUND_RED | FOREGROUND_WHITE);  
	...
	// Puls oder Rahmen Puls
	PCI_CntrlRegSet(Cardauswahl, Cntrl_Puls2_Rahmen_Off, ErrorStatus);
	...
	if((CntrlRegValue & Ctrl_Puls2_Rahmen_On) != 0)
	{
		if(ScreenOut)
		{
			SetConsoleTextAttribute(hConsoleOut, BACKGROUND_RED | FOREGROUND_WHITE);  
	...
	{
		SetConsoleTextAttribute(hConsoleOut, BACKGROUND_GREEN | FOREGROUND_WHITE);  
		cout<<"...Press Enter to send Pulse 1 & 2 ...";
		SetConsoleTextAttribute(hConsoleOut, BACKGROUND_BLACK | FOREGROUND_WHITE);
		getchar();
