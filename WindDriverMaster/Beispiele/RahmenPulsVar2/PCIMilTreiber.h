...
extern "C" DWORD PCI_IntEnable   (BYTE CardNr, MYDRIVER_INT_HANDLER funcIntHandler, void *pUserDat, DWORD &ErrorStatus);
...
extern "C" DWORD PCI_IntNextEnable(BYTE CardNr, DWORD &UserStatus);
