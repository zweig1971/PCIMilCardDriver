...
type t_Error_Char = array [1..20] of char;
...
type sonstiges =(EventOn, EventOff, EventTimerClear, EventTimerRun,
	         ...
	         Cntrl_Puls1_Rahmen_On, Cntrl_Puls1_Rahmen_Off,
                 Cntrl_Puls2_Rahmen_On,Cntrl_Puls2_Rahmen_Off, PulsBuchse_1,
                 PulsBuchse_2, Puls, RahmenPuls);
...
function PCI_DriverClose (CardNr:Integer): Integer;
                          cdecl; external 'PCIMilTreiber.dll';

function PCI_IfkOnline   (CardNr:Integer; IFCNr:Byte; var ReturnIFKNR:Byte;
                          var ErrorStatus:Integer):Integer; cdecl;
                          external 'PCIMilTreiber.dll';
...
function PCI_StatusRegRead(CardNr:Integer;StatusReg:Integer;
                           var ErrorStatus:Integer):Integer;
                           cdecl; external 'PCIMilTreiber.dll';
