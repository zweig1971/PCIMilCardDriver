...
extern "C" DWORD PCI_ErrorString (BYTE status, BYTE* error_string);
...
extern "C" DWORD PCI_IntEnable   (BYTE CardNr, DWORD &ErrorStatus);
...
extern "C" DWORD PCI_IntWaitStop (BYTE CardNr, DWORD &ErrorStatus);
