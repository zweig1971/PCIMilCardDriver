...
extern "C" int PCI_StatusRegRead(int CardNr, DWORD &StatusReg, DWORD &ErrorStatus);
...
extern "C" bool PCI_StatusTest (int CardNr, DWORD StatusBit, DWORD &ErrorStatus);
extern "C" int PCI_DataFiFoRead(int CardNr, WORD &data, bool &Fifo_not_empty ,DWORD &ErrorStatus);
...
extern "C" int PCI_SoftPuls1Start(int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls1Stop (int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls2Start(int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls2Stop (int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls3Start(int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls3Stop (int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls4Start(int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls4Stop (int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls5Start(int CardNr, DWORD &ErrorStatus);
extern "C" int PCI_SoftPuls5Stop (int CardNr, DWORD &ErrorStatus);
